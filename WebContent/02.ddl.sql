...
DROP TRIGGER PRIDUCT_SEQ;
CREATE SEQUENCE PRIDUCT_SEQ
	START WITH 1
		INCREMENT BY 1;
	
	--트리거를 이용하여 자동으로 번호가 입력되도록 
	
CREATE OR REPLACE TRIGGER TRI_PRIDUCT_CODE_AUTOSEQ
BEFORE INSERT ON PRODUCT
FOR EACH ROW
BEGIN
   IF Inserting AND :NEW.NO IS NULL THEN
      SELECT PRIDUCT_SEQ.NEXTVAL INTO :NEW.NO FROM DUAL;
   END IF;
END;

INSERT INTO PRIDUCT_SEQ VALUES(NULL,'test');

SELECT * FROM TRI_TEST;

INSERT INTO PRIDUCT_SEQ(txt) VALUES('test2');
